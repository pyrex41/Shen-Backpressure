# Code generated by shengen-ex derive from examples/phoenix-ash-tenant/specs/core.shen (define member-of?). DO NOT EDIT.
#
# Spec-equivalence test: Tenant.Authz.member_of?/2 must agree with the Shen
# definition of member-of? evaluated in-process by shen-erl (the Shen kernel
...
# sibling shen-erl checkout. Signature: {string --> (list string) --> boolean}
defmodule Tenant.Authz.MemberOfSpecTest do
  ...
  @spec_path "examples/phoenix-ash-tenant/specs/core.shen"
  @shen_fun :"member-of?"
  @max_cases 500
  ...
  test "member-of? agrees with Tenant.Authz.member_of?/2 on the boundary pool", %{oracle: oracle} do
    cases = cases()
    ...
    failures =
      ...
      |> Enum.flat_map(fn {[a1, a2] = args, index} ->
        ...
        impl = Tenant.Shen.Term.to_shen(Tenant.Authz.member_of?(a1, a2))
  ...
  property "member-of? agrees with Tenant.Authz.member_of?/2 on StreamData draws", %{oracle: oracle} do
    check all a1 <- gen_string(), a2 <- gen_list_of_string(), max_runs: 100 do
      assert oracle_call(oracle, [a1, a2]) == Tenant.Shen.Term.to_shen(Tenant.Authz.member_of?(a1, a2))
    end
  end

  defp cases do
    product = cartesian([pool_string(), pool_list_of_string()])
