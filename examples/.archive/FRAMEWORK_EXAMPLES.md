...
- Tech stack recommendations addressing performance concerns
- Tailored prompts for the Ralph/five-gate LLM loop
...
These examples collectively tell a compelling story: *One formal specification language (Shen) as the unchanging core of truth, allowing polyglot deployment across performance spectra and ecosystems.* 

- Start with Hono as it's closest to existing TS runtime.
- Use the prompts to iteratively build via the established loop.
- Benchmark all against each other on key metrics: latency, throughput, bug rate, developer velocity.
- Document "before Shen" vs "after" stories for each to strengthen the rhetorical impact.
- Extend with bidirectional transpiler and Shen-light layers in follow-up.
